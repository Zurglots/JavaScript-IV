...
class GameObject {
  ...
  destroy() {
    return `${this.name} was removed from the game. Get good, nerd.`;
  }
}
// () {
//   return `${this.name} was created on ${this.createdAt}`
// };
...
class Humanoid extends CharacterStats {
  ...
  greet() {
    return `${this.name} offers a formal high five in ${this.language}.`;
  }
}
